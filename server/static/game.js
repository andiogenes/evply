...
var Main = function() {
	...
	this.loader = new PIXI.loaders.Loader("static/assets/");
...
var editor_gui_CursorSelector = function(cursorHandler,handHandler,magnifierHandler) {
	...
	var left = new editor_gui_SelectorElement(editor_gui_ButtonAlignType.Left,50,25,PIXI.Texture.from("static/assets/cursor.png"));
	left.on("pointerdown",cursorHandler);
	var center = new editor_gui_SelectorElement(editor_gui_ButtonAlignType.Center,50,25,PIXI.Texture.from("static/assets/hand.png"));
	center.position.x = 50;
	center.on("pointerdown",handHandler);
	var right = new editor_gui_SelectorElement(editor_gui_ButtonAlignType.Right,50,25,PIXI.Texture.from("static/assets/magnifier.png"));
...
var editor_gui_EvalSelector = function(handler) {
	PIXI.Container.call(this);
	this.interactive = true;
	var button = new editor_gui_SelectorElement(editor_gui_ButtonAlignType.Center,50,25,PIXI.Texture.from("static/assets/eval.png"));
